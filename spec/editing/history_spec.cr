...
Spectator.describe TermBuf::Widgets::History do
  describe "#add" do
    it "keeps entries newest last" do
      history = TermBuf::Widgets::History.new
      history.add "one"
      history.add "two"
    ...
    it "drops the oldest once it is full" do
      history = TermBuf::Widgets::History.new capacity: 2
      history.add "one"
      history.add "two"
      history.add "three"
  ...
  describe "prefix search" do
    it "visits only the entries beginning with what was typed" do
      history = TermBuf::Widgets::History.new search: TermBuf::Widgets::History::Search::Prefix
  ...
  describe "storage" do
    it "writes and reads one entry per line" do
      ...
      restored = TermBuf::Widgets::History.new
...
Spectator.describe TermBuf::Widgets::Completion do
