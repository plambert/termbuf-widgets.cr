...
private def buffer(text : String = "") : TermBuf::Widgets::LineBuffer
  TermBuf::Widgets::LineBuffer.new text
end
...
Spectator.describe TermBuf::Widgets::LineBuffer do
  describe "counting" do
    ...
    it "measures with the policy it was given" do
      ...
      line = TermBuf::Widgets::LineBuffer.new "\u{1F468}\u{200D}\u{1F469}", narrow
  ...
  describe "properties" do
    it "leaves the text unchanged when an insert is taken back" do
      ...
      12.times do
        ...
        line.insert added
        TermBuf::Widgets::LineBuffer.new(added).size.times { line.delete_backward }
